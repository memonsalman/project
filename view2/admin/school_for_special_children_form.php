...
<html>
    ...
    <head>
        ...
        <title>School For Special Children Form</title>
                                ...
                                <div class="graph-2 general">
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="float: right;">
                                            <a href="<?php echo site_url("admin/schoolupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid-1">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <form method="post" class="form-horizontal" action="<?php base_url("admin/school_for_special_children_form") ?>" enctype="multipart/form-data" >
                                                ...
                                                <div align="center" class="row">
                                                    ...
                                                    <div class="col-lg-4">Education & Training / School For Special Children</div>
...
<?php endforeach; ?>
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div style="float: left;" class="col-lg-4">Doctors </div>

                                                    <div class="col-lg-4">

                                                        <textarea class="form-control" name="doc" value="<?php echo set_value('doc'); ?>"><?php echo @$ed[0]->area; ?></textarea>


                        <!-- <input type="text" class="form-control" name="doc" value="<?php echo set_value('doc'); ?>"> -->

                                                    </div>

                                                    <div class="col-lg-4">

                                                        <span style="color: red;"><?php echo form_error('doc'); ?></span>
                                ...
                                <!-- <input type="text" class="form-control" name="addr" value="<?php echo set_value('addr'); ?>"> -->
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div class="col-lg-8" style="float: center">
                                                        ...
                                                        <input type="submit" name="school_f">
