        ...
        <div class="forms-main">
            ...
            <div class="set-1">
                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/mbaupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/mba") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / MBA</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php set_value('name'); ?><?php echo @$ed[0]->name; ?>">
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox"  value="Class Room" <?php if (in_array("Class Room", $hh)) {
														    echo "checked='checked'";
														} ?> name="category[]" <?php if ($this->input->post('category')) {
														    $ar = $this->input->post('category');
														    if (in_array('Class Room', $ar)) {
														        echo "checked";
														    }
														} ?> > Class Room</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox"   value="Distance Learning" <?php if (in_array("Distance Learning", $hh)) {
														    echo "checked='checked'";
														} ?> name="category[]" <?php if ($this->input->post('category')) {
														    $ar = $this->input->post('category');
														    if (in_array('Distance Learning', $ar)) {
														        echo "checked";
														    }
                                ...
                                <!-- COMPETITIVE EXAMS TRAINING OFFERED Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Competitive Exam Training Offered</div>

                                    <div class="col-lg-4">
                                        <textarea class="form-control" name="exam" value="<?php echo set_value('exam'); ?>"><?php echo @$ed[0]->exam; ?></textarea>
               <!-- <input type="text" class="form-control" name="exam"  value="<?php echo set_value('exam'); ?>"> -->
                                ...
                                <!-- COMPETITIVE EXAMS TRAINING OFFERED End -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <textarea class="form-control" name="result" value="<?php echo set_value('result'); ?>"><?php echo @$ed[0]->result; ?></textarea>
                        ...
                        <!-- <input type="text" class="form-control" name="result" value="<?php echo set_value('result', $this->session->userdata('result')); ?>"> -->
                                ...
                                <!--        <div align="" class="row form-group">
                                         ...
                                         <div class="col-lg-4">
                                             ...
                                             <input type="text" class="form-control" name="award" value="<?php echo set_value('award', $this->session->userdata('award')); ?>">
                     
                                         </div>
                     
                                         <div class="col-lg-4">
                     
                                             <span style="color: red;"><?php echo form_error('award'); ?></span>
                        ...
                        <!-- <input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo set_value('phone', $this->session->userdata('phone')); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="email" value="<?php echo set_value('email', $this->session->userdata('email')); ?><?php echo @$ed[0]->email; ?>">
                        ...
                        <!-- <input type="text" class="form-control" name="addr" value="<?php echo set_value('addr'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="fb" value="<?php echo set_value('fb', $this->session->userdata('fb')); ?><?php echo @$ed[0]->fb; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="link" value="<?php echo set_value('link', $this->session->userdata('link')); ?><?php echo @$ed[0]->link; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" rows="5" id="comment" name="desc1" value="<?php echo set_value('desc1', $this->session->userdata('desc1')); ?>"><?php echo @$ed[0]->desc1; ?></textarea>
