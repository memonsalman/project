		...
		<div class="set-1">
			...
			<div class="graph-2 general">
				...
				<h3 class="inner-tittle two">Post Free Ad  </h3>
					...
					<div class="grid-1">
						...
						<div class="form-body">
							...
							<form method="post" class="form-horizontal" action="<?php base_url("admin/extras_form") ?>" enctype="multipart/form-data" >
                    ...
                    <div class="col-lg-4">Education & Training / Extra Fields</div>
               ...
               <!-- <ul>
				...
				<!-- Fields Selection Start -->



                	<div align="" class="row form-group">

	                    <div class="col-lg-4">Fields</div>
	                        ...
	                        <div class="multiselect">
							    ...
							    <div id="checkboxes">
							      ...
							      <label for="one">
							        ...
							        <input type="checkbox"  value="BEAUTICIAN" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('BEAUTICIAN',$ar)) { echo "checked"; } } ?> > BEAUTICIAN</label>

							      <label for="two">

							        <input type="checkbox"   value="DIETITIAN" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('DIETITIAN',$ar)) { echo "checked"; } } ?> > DIETITIAN</label>

							      <label for="three">

							      	<input type="checkbox"   value="PHYSICAL FITNESS" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('PHYSICAL FITNESS',$ar)) { echo "checked"; } } ?> > PHYSICAL FITNESS</label>

							      <label for="three">

							      	<input type="checkbox"  value="DIGITAL MARKETING" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('DIGITAL MARKETING',$ar)) { echo "checked"; } } ?> > DIGITAL MARKETING</label>

							      <label for="three">

							      	<input type="checkbox"   value="FILM MAKING" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('FILM MAKING',$ar)) { echo "checked"; } } ?> > FILM MAKING</label>  

							      <label for="three">

							     	<input type="checkbox"   value="CINEMATICS" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('CINEMATICS',$ar)) { echo "checked"; } } ?> > CINEMATICS</label>

							      <label for="three">

							      	<input type="checkbox"  value="CINEMATOGRAPGY" name="field[]" <?php if($this->input->post('field')) { $ar=$this->input->post('field'); if( in_array('CINEMATOGRAPGY',$ar)) { echo "checked"; } } ?> > CINEMATOGRAPGY</label>	
	                    ...
	                    <div class="col-lg-4">
	                        ...
	                        <span style="color: red;"><?php echo form_error('field[]'); ?></span>
				...
				<!-- Name Start -->
                  ...
                  <!-- <div align="" class="row form-group">
                	...
                	<!-- Exam Training Offered Start -->

                	

                	<!-- Exam Training Offered End -->





                	<!-- Couselling Fees Start -->

                	

                  <!-- Counselling Fees End -->



                  <!-- Certification Offered Start -->



                  <div align="" class="row form-group">

	                    <div class="col-lg-4">Certification Offered</div>

	                    <div class="col-lg-4">

	                        <div class="multiselect">

							    <div class="selectBox" onclick="certification()">
							    ...
							    <div id="certification">
							      ...
							      <label for="one">
							        ...
							        <input type="checkbox" id="one" value="CEED" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('CEED',$ar)) { echo "checked"; } } ?> > CEED</label>

							      <label for="two">

							        <input type="checkbox" id="two"  value="NIFT" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('NIFT',$ar)) { echo "checked"; } } ?> > NIFT</label>

							      <label for="three">

							      	<input type="checkbox" id="two"  value="FDDI" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('FDDI',$ar)) { echo "checked"; } } ?> > FDDI</label>

							      <label for="three">

							      	<input type="checkbox" id="two"  value="AISST" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('AISST',$ar)) { echo "checked"; } } ?> > AISST</label>

							      <label for="three">

							      	<input type="checkbox" id="two"  value="NID" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('NID',$ar)) { echo "checked"; } } ?> > NID</label>  

							      <label for="three">

							     	<input type="checkbox" id="two"  value="NATA" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('NATA',$ar)) { echo "checked"; } } ?> > NATA</label>

							      <label for="three">

							      	<input type="checkbox" id="two"  value="Others" name="certification[]" <?php if($this->input->post('certification')) { $ar=$this->input->post('certification'); if( in_array('Others',$ar)) { echo "checked"; } } ?> > Others</label>	
	                    ...
	                    <div class="col-lg-4">
	                        ...
	                        <span style="color: red;"><?php echo form_error('certification[]'); ?></span>
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">Awards & Honours</div>
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="text" class="form-control" name="webl" value="<?php echo set_value('webl'); ?>">
                  ...
                  <!-- Professional Statement Start -->
                   ...
                   <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                       ...
                       <textarea class="form-control" rows="5" id="comment" name="desc" value="<?php echo set_value('desc'); ?>"></textarea>
