                            ...
                            <div class="graph-2 general">
                               ...
                               <div class="row">
                                    ...
                                    <div style="float: right;">
                                        <a href="<?php echo site_url("admin/indexblogupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-1">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form class="form-horizontal" method="post" action="<?php base_url("admin/indexblog") ?>" enctype="multipart/form-data">

                                            <div align="center" class="row">

                                                <div class="col-lg-4">Selected Category</div>

                                                <div class="col-lg-4">Education & Training / Index Blog</div>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div style="float: left;" class="col-lg-4">Title for your Blog*</div>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div style="float: left;" class="col-lg-4">URL for your Blog*</div>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div style="float: left;" class="col-lg-4">Photo for your Image</div>
                                            ...
                                            <div align="" class="row form-group">
							                    ...
							                    <div class="col-lg-4">Content For Blog</div>

							                    <div class="col-lg-4">

							                    	<textarea class="form-control" name="content" value="<?php echo set_value('content'); ?>"></textarea>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div class="col-lg-8" style="float: center">
                                                    ...
                                                    <input type="submit" name="indexblog">
