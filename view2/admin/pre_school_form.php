                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/preupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/pre_school_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Pre School Form</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Activities</div>
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    @$hh = explode(",", $h);
                                                    ?>
                                                    <input type="checkbox"  value="Toddler" <?php
                                                    if (in_array("Toddler", $hh)) {
                                                        echo "checked='checked'";
                                                    }
                                                    ?> name="activity[]" <?php
                                                           if ($this->input->post('activity')) {
                                                               $ar = $this->input->post('activity');
                                                               if (in_array('Toddler', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?>  > Toddler</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox"   value="Nursery" <?php
                                                           if (in_array("Nursery", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="activity[]" <?php
                                                           if ($this->input->post('activity')) {
                                                               $ar = $this->input->post('activity');
                                                               if (in_array('Nursery', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Nursery</label>
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox"   value="LKG" <?php
                                                           if (in_array("LKG", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="activity[]" <?php
                                                ...
                                                <label for="four">
                                                    ...
                                                    <input type="checkbox"   value="UKG" <?php
                                                           if (in_array("UKG", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?>  name="activity[]" <?php
                               ...
                               <!--  <span style="color: red;"><?php echo form_error('activity[]'); ?></span> -->

                                    </div>

                                </div>

                                <!-- Activities dropdown end  -->



                                <!-- Reason for such activity Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Reason for such activity</div>

                                    <div class="col-lg-4">

                                        <textarea class="form-control" rows="5" id="reason" name="reason" value="<?php echo set_value('reason'); ?> "><?php echo @$ed[0]->reason; ?></textarea>

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('reason'); ?></span>

                                    </div>

                                </div>

                                <!-- Reason for such activity End  -->


                                <!-- Modes of Communication with parents dropdown start  -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Modes of Communication</div>

                                    <div class="col-lg-4">

                                        <div class="multiselect">

                                            <div class="selectBox" onclick="showModes()">
                                            ...
                                            <div id="modes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox"  value="Phone" <?php
                                                           if (in_array("Phone", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="modes[]" <?php
                                                           if ($this->input->post('modes')) {
                                                               $ar = $this->input->post('modes');
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox"   value="Almanack" <?php
                                                           if (in_array("Almanack", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="modes[]" <?php
                                                           if ($this->input->post('modes')) {
                                                               $ar = $this->input->post('modes');
                                                               if (in_array('Almanack', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Almanack</label>
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox"   value="Social Media" <?php
                                                           if (in_array("Social Media", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="modes[]" <?php
                                                           if ($this->input->post('modes')) {
                                                               $ar = $this->input->post('modes');
                                                               if (in_array('Social Media', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Social Media</label>
                               ...
                               <!--  <span style="color: red;"><?php echo form_error('modes[]'); ?></span> -->

                                    </div>

                                </div>

                                <!-- Modes of Communication with parents dropdown end  -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Ongoing Development</div>

                                    <div class="col-lg-4">

                                        <textarea class="form-control" rows="5" id="devlopment" name="devlopment" value="<?php echo set_value('devlopment'); ?>"><?php echo @$ed[0]->devlopment; ?></textarea>

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('devlopment'); ?></span>

                                    </div>

                                </div>

                                <!-- Ongoing Development End  -->

                                <!-- Teacher-child ratio Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Teacher-Child Ratio </div>

                                    <div class="col-lg-4">

                                        <textarea class="form-control" name="ratio" value="<?php echo set_value('ratio'); ?>"><?php echo @$ed[0]->ratio; ?></textarea>

                        <!-- <input type="text" class="form-control" name="ratio"  value="<?php echo set_value('ratio'); ?>"> -->

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('ratio'); ?></span>

                                    </div>

                                </div>

                                <!-- Teacher-child ratio End -->


                                <!-- Teacher-child ratio comment Start -->

                                <!-- <div align="" class="row form-group">
              
                                  <div class="col-lg-4">Teacher-Child comment Ratio </div>
              
                                  <div class="col-lg-4">
              
                                      <input type="text" class="form-control" name="ratiocmt"  value="<?php echo set_value('ratiocmt'); ?>">
              
                                  </div>
              
                                  <div class="col-lg-4">
              
                                      <span style="color: red;"><?php echo form_error('ratiocmt'); ?></span>
              
                                  </div>
              
                                </div> -->

                                <!-- Teacher-child ratio comment End -->
                        ...
                        <!-- <input type="text" class="form-control" name="fees" value="<?php echo set_value('fees'); ?>"> -->
                                ...
                                <!-- Fees Aproximately comment Start -->



                                <!-- <div align="" class="row form-group">
              
                                  <div class="col-lg-4">Fees Aproximately Comment</div>
              
                                  <div class="col-lg-4">
              
                                      <input type="text" class="form-control" name="feescmt" value="<?php echo set_value('feescmt'); ?>">
              
                                  </div>
              
                                  <div class="col-lg-4">
              
                                      <span style="color: red;"><?php echo form_error('feescmt'); ?></span>
                        ...
                        <!-- <input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo set_value('phone'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="addr" value="<?php echo set_value('addr'); ?><?php echo @$ed[0]->addr; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="webl" value="<?php echo set_value('webl'); ?><?php echo @$ed[0]->link; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" rows="5" id="comment" name="desc" value="<?php echo set_value('desc'); ?>"><?php echo @$ed[0]->desc1; ?></textarea>
