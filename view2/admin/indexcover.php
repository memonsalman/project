                            ...
                            <div class="graph-2 general">
                               ...
                               <div class="row">
                                    ...
                                    <div style="float: right;">
                                        <a href="<?php echo site_url("admin/indexcoverupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-1">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form class="form-horizontal" method="post" action="<?php base_url("admin/indexcover") ?>" enctype="multipart/form-data">

                                            <div align="center" class="row">

                                                <div class="col-lg-4">Selected Category</div>

                                                <div class="col-lg-4">Education & Training / Index Cover</div>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div style="float: left;" class="col-lg-4">Title for your Cover*</div>
                                            ...
                                            <div align="" class="row form-group">
                                                ...
                                                <div class="col-lg-8" style="float: center">
                                                    ...
                                                    <input type="submit" name="indexcover">
