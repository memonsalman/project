...
<div class="container">
	...
	<div class="row">
		<div style="float: right;padding-bottom: 50px;padding-top: 50px;">
			<a href="<?php echo base_url('admin/medical'); ?>"><button type="button" class="btn btn-info">Add New</button></a>
		</div>
	...
	<table class="table" border="1" align="center">
		...
		<tbody>
			...
			<tr>
				...
				<td>	
				<button onclick="location.href='<?php echo base_url("admin/medical/".$k->mid) ?>'" type="button" class="btn btn-info">Edit</button>
				</td>

				<td>	
				<button onclick="location.href='<?php echo base_url("admin/medicaldelet/".$k->mid) ?>'" type="button" class="btn btn-danger">Delete</button>
				</td>
			</tr>
			<?php
			$i++;
