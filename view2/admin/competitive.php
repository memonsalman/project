	  ...
	  <!--/set-2-->
		...
		<div class="set-1">
			...
			<div class="graph-2 general">
				...
				<h3 class="inner-tittle two">Post Ad  </h3>
				...
				<div class="form-body">
                    ...
                    <div class="col-lg-4">Education & Training / Competitive_Exam_Form</div>

                    <div class="col-lg-4"><a href="<?php echo site_url("admin/home"); ?>">Choose Another Category</a></div>

                </div><br>

                <form method="post" action="<?php base_url("admin/competitive") ?>" enctype="multipart/form-data">
				...
				<div align="center" class="row">
                  ...
                  <div align="" class="row form-group">
                   ...
                   <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="photo1" value="<?php echo set_value('photo1'); ?>" accept="image/*">
                  ...
                  <!-- </div> -->
                   ...
                   <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="photo2" value="<?php echo set_value('photo2'); ?>" accept="image/*">
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="photo3" value="<?php echo set_value('photo3'); ?>" accept="image/*">
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="photo4" value="<?php echo set_value('photo4'); ?>" accept="image/*">
              ...
              <!--     </div> -->
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="photo5" value="<?php echo set_value('photo5'); ?>" accept="image/*">
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <input type="file" name="pdf" value="<?php echo set_value('pdf'); ?>">
                 ...
                 <!--  </div> -->
                  ...
                  <!-- <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">Prospect</div>

                    <div class="col-lg-4">

                          <input type="file" name="photo2" value="<?php echo set_value('photo2'); ?>">
                ...
                <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">Training Offer</div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="multiselect">
						    ...
						    <div id="checkboxes">
						      ...
						      <label for="one">
						        ...
						        <input type="checkbox"  value="MAT" name="training[]" <?php if($this->input->post('competitive')) { $ar=$this->input->post('training'); if( in_array('MAT',$ar)) { echo "checked"; } } ?> > MAT</label>

						      <label for="two">

						        <input type="checkbox"   value="NEET" name="training[]" <?php if($this->input->post('competitive')) { $ar=$this->input->post('training'); if( in_array('NEET',$ar)) { echo "checked"; } } ?> > NEET</label>

						     

						      	<label for="three">

						      	<input type="checkbox"   value="CAT" name="training[]" <?php if($this->input->post('competitive')) { $ar=$this->input->post('training'); if( in_array('CAT',$ar)) { echo "checked"; } } ?> > CAT</label>

						      	<label for="three">

						      	<input type="checkbox"   value="GATE" name="training[]" <?php if($this->input->post('competitive')) { $ar=$this->input->post('training'); if( in_array('GATE',$ar)) { echo "checked"; } } ?> > GATE</label>

						      	<label for="three">

						      	<input type="checkbox"   value=" Other" name="training[]" <?php if($this->input->post('competitive')) { $ar=$this->input->post('training'); if( in_array(' Other',$ar)) { echo "checked"; } } ?> >  Other</label>
                     ...
                     <div class="col-lg-4">
                        ...
                        <span style="color: red;"><?php echo form_error('training[]'); ?></span>
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">Coaching Fees</div>
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-4">
                         ...
                         <select class="form-control" id="sel1" name="delivery">
                  ...
                  <div align="" class="row form-group">
                    ...
                    <div class="col-lg-8" style="float: center">
                       ...
                       <input type="submit" name="competitive">
