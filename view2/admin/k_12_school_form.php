                            ...
                            <div class="graph-2 general">
                            	...
                            	<div class="row">
                                    ...
                                    <div style="float: right;">
                                        <a href="<?php echo site_url("admin/k12update"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                    </div>
                                </div>					
                                <div class="grid-1">						
                                    <div class="form-body">							
                                        <form method="post" class="form-horizontal" action="<?php base_url("admin/k_12_school_form") ?>" enctype="multipart/form-data" >																
                                            <div align="center" class="row">                    
                                                <div class="col-lg-4">Selected Category</div>                    
                                                <div class="col-lg-4">Education & Training / K-12 School</div>                    
...
<?php endforeach; ?>				
                                            ...
                                            <div align="" class="row form-group">	                    
                                                    ...
                                                    <div class="multiselect">							    
                                                        ...
                                                        <div id="checkboxes">							       
                                                            <label for="one">		
                                                                ...
                                                                @$hh = explode(",", $h);
                                                                ?>					        
                                                                <input type="checkbox"  value="State" <?php if (in_array("State board", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="board[]" <?php if ($this->input->post('board')) {
                                                                    $ar = $this->input->post('board');
                                                                    if (in_array('State board', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?> > State Board</label>							      
                                                            <label for="two">							        
                                                                <input type="checkbox"   value="CBSC" <?php if (in_array("CBSC", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="board[]" <?php if ($this->input->post('board')) {
                                                                    $ar = $this->input->post('board');
                                                                    if (in_array('CBSC', $ar)) {
                                                            ...
                                                            <label for="three">						        
                                                                <input type="checkbox"   value="ICSC" <?php if (in_array("ICSC", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="board[]" <?php if ($this->input->post('board')) {
                                                                    $ar = $this->input->post('board');
                                                                    if (in_array('ICSC', $ar)) {
                                                ...
                                                <div class="col-lg-4">	                        
                                                    <span style="color: red;"><?php echo form_error('board[]'); ?></span>	                    
                                                </div>                	
                                            </div>                  
                                            <!-- Board End -->                  
                                            <!-- Prospectus Start -->                   
...
<?php echo form_error('addr'); ?>
            ...
            <div class="sidebar-menu" hidden="true">					
                <header class="logo">					
                    ...
                    <a href="index.html"> 
                        <span id="logo"> <h1>Augment</h1></span> 						
                ...
                <!--/down-->							
                <div class="down">										  
                    <a href="index.html"><img src="<?php echo base_url(); ?>assets2/images/admin.jpg"></a>									  <a href="index.html"><span class=" name-caret">Jasmin Leo</span></a>									 <p>System Administrator in Company</p>									
                    <ul>									
                ...
                <div class="menu">									
                    <ul id="menu" >										
                        <li><a href="index.html">
                                <i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Tabs &amp; Panels</span> <span class="fa fa-angle-right" style="float: right"></span></a>										   <ul id="menu-academico-sub" >											
                        ...
                        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Ui Elements</span> 
                        ...
                        <li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Pages</span> 
                                <span class="fa fa-angle-right" style="float: right"></span></a>									
                            <ul id="menu-academico-sub" >										    
                        ...
                        <li><a href="#"><i class="lnr lnr-envelope"></i> <span>Mail Box</span>
                                <span class="fa fa-angle-right" style="float: right"></span></a>									   <ul>										
                        ...
                        <li id="menu-academico" ><a href="#"><i class="lnr lnr-layers"></i> <span>Components</span> 
                                <span class="fa fa-angle-right" style="float: right"></span></a>									
                            <ul id="menu-academico-sub" >											
                        ...
                        <li><a href="chart.html"><i class="lnr lnr-chart-bars"></i> <span>Charts</span> 
                                <span class="fa fa-angle-right" style="float: right"></span></a>									  <ul>										
                        ...
                        <li id="menu-comunicacao" ><a href="#"><i class="fa fa-smile-o"></i> <span>More</span>
                                <span class="fa fa-angle-double-right" style="float: right"></span></a>								
