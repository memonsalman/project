                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/campupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/camps_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Camps</div>
                                ...
                                <!-- Nature Of Camps Start -->



                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Nature Of Camp</div>
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox"  value="SUMMER" <?php
                                                           if (in_array("SUMMER", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="camp[]" <?php
                                                           if ($this->input->post('camp')) {
                                                               $ar = $this->input->post('camp');
                                                               if (in_array('SUMMER', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > SUMMER</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox"   value="SCIENCE" name="camp[]" <?php
                                                           if (in_array("SCIENCE", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="camp[]" <?php
                                                           if ($this->input->post('camp')) {
                                                               $ar = $this->input->post('camp');
                                                               if (in_array('SCIENCE', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > SCIENCE</label>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <span style="color: red;"><?php echo form_error('camp[]'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" name="activity"  value="<?php echo set_value('activity'); ?>"><?php echo @$ed[0]->activity; ?></textarea>

                        <!-- <input type="text" class="form-control" name="activity"  value="<?php echo set_value('activity'); ?>"> -->
                                ...
                                <!-- 
                                                  <div align="" class="row form-group">
                                                    ...
                                                    <div style="float: left;" class="col-lg-4">Activities </div>
                                
                                                    <div class="col-lg-4">
                                
                                                        <input type="text" class="form-control" name="act" value="<?php echo set_value('act'); ?>">
                                
                                                    </div>
                                
                                                    <div class="col-lg-4">
                                
                                                        <span style="color: red;"><?php echo form_error('act'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">BRIEF DESCRIPTION (100 WORDS)</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Venue</div>

                                    <div class="col-lg-4">

                                        <input type="text" class="form-control" name="venue" value="<?php echo set_value('venue'); ?><?php echo @$ed[0]->venue; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" class="form-control" name="datef" value="<?php echo set_value('datef'); ?><?php echo @$ed[0]->datef; ?>">

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('datef'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="date" class="form-control" name="datet" value="<?php echo set_value('datet'); ?><?php echo @$ed[0]->datet; ?>">

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('datet'); ?></span>
                                ...
                                <!-- FB Pagelink Of Event Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">FB Pagelink of Event</div>
                                ...
                                <!-- FB Pagelink Of Event End -->



                                <!-- Link For Registration Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Link For Registration</div>

                                    <div class="col-lg-4">

                                        <input type="text" class="form-control" name="linkreg" value="<?php echo set_value('linkreg'); ?><?php echo @$ed[0]->link; ?>">

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('linkreg'); ?></span>

                                    </div>

                                </div>

                                <!-- Link For Registration End -->
                        ...
                        <!-- <input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo set_value('phone'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" rows="5" id="comment" name="cmmt" value="<?php echo set_value('cmmt'); ?>"><?php echo @$ed[0]->cmmt; ?></textarea>

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('cmmt'); ?></span>
