                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/careerupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/career") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Career Counseling</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div style="float: left;" class="col-lg-4">Title </div>

                                    <div class="col-lg-4">

                                        <input type="text" class="form-control" name="title" value="<?php echo set_value('title'); ?><?php echo @$ed[0]->title; ?>">
                                ...
                                <div align="" class="raw form-group">

                                    <div class="col-lg-4">Education Stream</div>
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox"  value="Design" <?php
                                                    if (in_array("Design", $hh)) {
                                                        echo "checked='checked'";
                                                    }
                                                    ?> name="Education_Stream[]" <?php
                                                           if ($this->input->post('Education_Stream')) {
                                                               $ar = $this->input->post('Education_Stream');
                                                               if (in_array('Design', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Design</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox"   value="Engineering" <?php
                                                           if (in_array("Engineering", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="Education_Stream[]" <?php
                                                           if ($this->input->post('Education_Stream')) {
                                                               $ar = $this->input->post('Education_Stream');
                                                               if (in_array('Engineering', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Engineering</label>
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox"   value="MBA" <?php
                                                           if (in_array("MBA", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="Education_Stream[]" <?php
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox"   value="Medical" <?php
                                                           if (in_array("Medical", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="Education_Stream[]" <?php
                                                           if ($this->input->post('Education_Stream')) {
                                                               $ar = $this->input->post('Education_Stream');
                                                               if (in_array('Medical', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Medical</label>
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox"   value="Others" <?php
                                                           if (in_array("Others", $hh)) {
                                                               echo "checked='checked'";
                                                           }
                                                           ?> name="Education_Stream[]" <?php
                                                           if ($this->input->post('Education_Stream')) {
                                                               $ar = $this->input->post('Education_Stream');
                                                               if (in_array('Others', $ar)) {
                                                                   echo "checked";
                                                               }
                                                           }
                                                           ?> > Others</label>  
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <span style="color: red;"><?php echo form_error('Education_Stream[]'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Counselling Fees</div>
                        ...
                        <!-- <input type="text" class="form-control" name="fees" value="<?php echo set_value('fees'); ?>"> -->
                                ...
                                <!-- Test Conducted Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Test Conducted</div>

                                    <div class="col-lg-4">

                                        <textarea class="form-control" name="test"  value="<?php echo set_value('test'); ?>"><?php echo @$ed[0]->test; ?></textarea>

                        <!-- <input type="date" class="form-control" name="test"  value="<?php echo set_value('test'); ?>"> -->
                                ...
                                <!-- Outcome of Such test Start -->

                                <div align="" class="row form-group">

                                    <div class="col-lg-4">Reason Behind such tests:(What outcome is determined from it):</div>

                                    <div class="col-lg-4">

                                        <textarea class="form-control" name="outcome"  value="<?php echo set_value('outcome'); ?>"><?php echo @$ed[0]->outcome; ?></textarea>

                        <!-- <input type="text" class="form-control" name="outcome"  value="<?php echo set_value('outcome'); ?>"> -->

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('outcome'); ?></span>

                                    </div>

                                </div>

                                <!-- Outcome of Such Test End -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="iname" value="<?php echo set_value('iname'); ?><?php echo @$ed[0]->iname; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="iadd" value="<?php echo set_value('iadd'); ?><?php echo @$ed[0]->iadd; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Institute Email Id</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="phone" value="<?php echo set_value('phone'); ?><?php echo @$ed[0]->phone; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="iweb" value="<?php echo set_value('iweb'); ?><?php echo @$ed[0]->iweb; ?>">
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="city" value="<?php echo set_value('city'); ?><?php echo @$ed[0]->city; ?>">
