...
<html>
    ...
    <head>
        ...
        <title>Skill Building for Other Age</title>
                                ...
                                <div class="graph-2 general">
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="float: right;">
                                            <a href="<?php echo site_url("admin/cocurr_oupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid-1">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <form method="post" class="form-horizontal" action="<?php base_url("admin/co_curriculars_other_form") ?>" enctype="multipart/form-data" >
                                                ...
                                                <div align="center" class="row">
                                                    ...
                                                    <div class="col-lg-4">Education & Training / Skill Building for Other Age Group People</div>
...
<?php endforeach; ?>
                                                ...
                                                <div align="" class="row form-group">
                                                        ...
                                                        <div class="multiselect">
                                                            ...
                                                            <div id="checkboxes">
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <input type="checkbox"   value="Art and Crafts" <?php if (in_array("Art and Crafts", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Art and Crafts', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Art and Crafts</label>

                                                                <label for="two">

                                                                    <input type="checkbox"   value="Cooking" <?php if (in_array("Cooking", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Cooking', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Cooking</label>
                                                                ...
                                                                <label for="three">
                                                                    ...
                                                                    <input type="checkbox"   value="Dance" <?php if (in_array("Dance", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Dance', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Dance</label>
                                                                ...
                                                                <label for="four">
                                                                    ...
                                                                    <input type="checkbox"   value="English Speaking" <?php if (in_array("English Speaking", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('English Speaking', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > English Speaking</label>

                                                                <label for="five">

                                                                    <input type="checkbox"   value="Mid Brain" <?php if (in_array("Mid Brain", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Mid Brain', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Mid Brain</label>
                                                                ...
                                                                <label for="six">
                                                                    ...
                                                                    <input type="checkbox"   value="Music" <?php if (in_array("Music", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Music', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Music</label>
                                                                ...
                                                                <label for="seven">
                                                                    ...
                                                                    <input type="checkbox"   value="Painting" <?php if (in_array("Painting", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Painting', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Painting</label>
                                                                ...
                                                                <label for="eight">
                                                                    ...
                                                                    <input type="checkbox"   value="Personality Development" <?php if (in_array("Personality Development", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Personality Development', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Personality Development</label>

                                                                <label for="nine">

                                                                    <input type="checkbox"   value="Phonics" <?php if (in_array("Phonics", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Phonics', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Phonics</label>
                                                                ...
                                                                <label for="ten">
                                                                    ...
                                                                    <input type="checkbox"   value="Public Speaking" <?php if (in_array("Public Speaking", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Public Speaking', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Public Speaking</label>

                                                                <label for="eleven">

                                                                    <input type="checkbox"   value="Sports" <?php if (in_array("Sports", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Sports', $ar)) {
                                                                        echo "checked";
                                                                    }
                                                                } ?>  > Sports</label>
                                                                ...
                                                                <label for="twelve">
                                                                    ...
                                                                    <input type="checkbox"   value="Yoga" <?php if (in_array("Yoga", $hh)) {
                                                                    echo "checked='checked'";
                                                                } ?> name="categories[]" <?php if ($this->input->post('categories')) {
                                                                    $ar = $this->input->post('categories');
                                                                    if (in_array('Yoga', $ar)) {
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <span style="color: red;"><?php echo form_error('categories[]'); ?></span>
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div class="col-lg-4">Subcategories</div>

                                                    <div class="col-lg-4">

                                                        <textarea class="form-control" name="subcategories[]" value="<?php echo set_value('subcategories'); ?>"><?php echo @$ed[0]->subcategories; ?></textarea>

                        <!-- <input type="text" class="form-control" name="subcategories[]"  value="<?php echo set_value('subcategories'); ?>"> -->

                                                    </div>

                                                    <div class="col-lg-4">

                                                        <span style="color: red;"><?php echo form_error('subcategories'); ?></span>
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div class="col-lg-4">Starting Fees</div>
...
<!-- <input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo set_value('phone'); ?>"> -->
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div class="col-lg-4">YOUTUBE Link</div>

                                                    <div class="col-lg-4">

                                                        <input type="text" class="form-control" name="yout" value="<?php echo set_value('yout'); ?><?php echo @$ed[0]->yout; ?>">

                                                    </div>

                                                    <div class="col-lg-4">

                                                        <span style="color: red;"><?php echo form_error('yout'); ?></span>
...
?>
                                                ...
                                                <div align="" class="row form-group">
                                                    ...
                                                    <div class="col-lg-8" style="float: center">
                                                        ...
                                                        <input type="submit" name="curriculars1">
