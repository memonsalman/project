...
<script src="<?php echo base_url(); ?>/assets2/js/amcharts.js"></script>	

<script src="<?php echo base_url(); ?>/assets2/js/serial.js"></script>	

<script src="<?php echo base_url(); ?>/assets2/js/light.js"></script>	

<script src="<?php echo base_url(); ?>/assets2/js/radar.js"></script>	

<link href="<?php echo base_url(); ?>/assets2/css/barChart.css" rel='stylesheet' type='text/css' />

<link href="<?php echo base_url(); ?>/assets2/css/fabochart.css" rel='stylesheet' type='text/css' />
...
<script src="<?php echo base_url(); ?>/assets2/js/jquery.easydropdown.js"></script>
												...
												<!--/candile-->
													...
													<div class="candile"> 
															...
															vis.render();
																	...
																	<script type="text/javascript" src="<?php echo base_url(); ?>/assets2/js/protovis-d3.2.js"></script>

																	<script type="text/javascript" src="<?php echo base_url(); ?>/assets2/js/vix.js"></script>
												    ...
												    <div class="chrt-bars">
														...
														<div class="col-md-6 chrt-two">
														 ...
														 <h3 class="sub-tittle">Bar Chart </h3>
															...
															<script src="<?php echo base_url(); ?>/assets2/js/fabochart.js"></script>
												...
												<div class="col-md-6 chrt-two area">
															...
															<h3 class="sub-tittle">Line Multi Chart</h3>
															 ...
															 <div style="area">
																...
																<script src="<?php echo base_url(); ?>/assets2/js/Chart.js"></script>
																		...
																		<ul class="clock-category">
																			...
																			<li>
																				...
																				<a href="#" class="active">
																					...
																					<img src="<?php echo base_url(); ?>/assets2/images/time.png" alt="">
																			...
																			<li>
																				...
																				<a href="#">
																					...
																					<img src="<?php echo base_url(); ?>/assets2/images/alarm.png" alt="">
																			...
																			<li>
																				...
																				<a href="#">
																					...
																					<img src="<?php echo base_url(); ?>/assets2/images/watch.png" alt="">
																			...
																			<li>
																				...
																				<a href="#">
																					...
																					<img src="<?php echo base_url(); ?>/assets2/images/timer.png" alt="">
                           ...
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Pages</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  ...
										  <ul id="menu-academico-sub" >
										    ...
										    <li id="menu-academico-avaliacoes" ><a href="login.html" style="cursor: pointer;">Login</a></li>

										    <li id="menu-academico-boletim" ><a href="register.html" style="cursor: pointer;">Register</a></li>
...
<script type="text/javascript" src="<?php echo base_url(); ?>/assets2/js/vroom.js"></script>

<script type="text/javascript" src="<?php echo base_url(); ?>/assets2/js/TweenLite.min.js"></script>

<script type="text/javascript" src="<?php echo base_url(); ?>/assets2/js/CSSPlugin.min.js"></script>
