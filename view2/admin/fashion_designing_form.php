...
<html>
    ...
    <head>
        ...
        <title>Fashion Desiging Form</title>
                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/fashionupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/fashion_designing_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Fashion Designing</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Exam Training Offered</div>
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox" id="one" value="CEED" <?php if (in_array("CEED", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('CEED', $ar)) {
														        echo "checked";
														    }
														} ?> > CEED</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox" id="two"  value="NIFT" <?php if (in_array("NIFT", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('NIFT', $ar)) {
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox" id="three"  value="FDDI" <?php if (in_array("FDDI", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('FDDI', $ar)) {
                                                ...
                                                <label for="four">
                                                    ...
                                                    <input type="checkbox" id="four"  value="AISST" <?php if (in_array("AISST", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('AISST', $ar)) {
														        echo "checked";
														    }
														} ?> > AISST</label>
                                                ...
                                                <label for="five">
                                                    ...
                                                    <input type="checkbox" id="five"  value="NID" <?php if (in_array("NID", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('NID', $ar)) {
                                                ...
                                                <label for="six">
                                                    ...
                                                    <input type="checkbox" id="six"  value="NATA" <?php if (in_array("NATA", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
														    if (in_array('NATA', $ar)) {
                                                ...
                                                <label for="seven">
                                                    ...
                                                    <input type="checkbox" id="seven"  value="Others" <?php if (in_array("Others", $hh)) {
														    echo "checked='checked'";
														} ?> name="Exam_training[]" <?php if ($this->input->post('Exam_training')) {
														    $ar = $this->input->post('Exam_training');
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <span style="color: red;"><?php echo form_error('Exam_training[]'); ?></span>
                        ...
                        <!-- <input type="text" class="form-control" name="addr" value="<?php echo set_value('addr'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-8" style="float: center">
                                        ...
                                        <input type="submit" name="fashion_design">
