...
<html>
    ...
    <head>
        ...
        <title>Corporate Skill Trainer</title>
                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/corporateupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form class="form-horizontal" method="post" action="<?php base_url("admin/corporate_form") ?>" enctype="multipart/form-data">

                                <div align="center" class="row">

                                    <div class="col-lg-4">Selected Category</div>

                                    <div class="col-lg-4">Education & Training / Corporate Skill Trainer</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div style="float: left;" class="col-lg-4">Services Offered*</div>

                                    <div class="col-lg-4">
                                        <textarea class="form-control" name="service" value="<?php echo set_value('service'); ?>"><?php echo @$ed[0]->service; ?></textarea>
                <!-- <input type="text" class="form-control" name="service" value="<?php echo set_value('service'); ?>"> -->
                ...
                <!-- <input type="text" class="form-control" maxlength="10" name="phone" value="<?php echo set_value('phone'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="web" value="<?php echo set_value('web'); ?><?php echo @$ed[0]->web; ?>">

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('web'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" rows="5" id="statment" name="statment" ><?php echo @$ed[0]->statment; ?></textarea>

                                    </div>

                                    <div class="col-lg-4">

                                        <span style="color: red;"><?php echo form_error('statment'); ?></span>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-8" style="float: center">
                                        ...
                                        <input type="submit" name="corporate">
