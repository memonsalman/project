...
<html>
    ...
    <head>
        ...
        <title>Jewellery Designing Form</title>
                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/jewelleryupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/jewellery_designing_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Jewellery Designing</div>
                        ...
                        <!-- <input type="text" class="form-control" name="certi" value="<?php echo set_value('certi'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">Course Offered</div>
                                        ...
                                        <div class="multiselect">
                                            ...
                                            <div id="checkboxes">
                                                ...
                                                <label for="one">
                                                    ...
                                                    <input type="checkbox" id="one" value="HAND" <?php if (in_array("HAND", $hh)) {
														    echo "checked='checked'";
														} ?> name="course[]" <?php if ($this->input->post('course')) {
														    $ar = $this->input->post('course');
														    if (in_array('HAND', $ar)) {
														        echo "checked";
														    }
														} ?> > HAND</label>
                                                ...
                                                <label for="two">
                                                    ...
                                                    <input type="checkbox" id="two"  value="CAD" <?php if (in_array("CAD", $hh)) {
														    echo "checked='checked'";
														} ?> name="course[]" <?php if ($this->input->post('course')) {
														    $ar = $this->input->post('course');
														    if (in_array('CAD', $ar)) {
                                                ...
                                                <label for="three">
                                                    ...
                                                    <input type="checkbox" id="two"  value="GRADING" <?php if (in_array("GRADING", $hh)) {
														    echo "checked='checked'";
														} ?> name="course[]" <?php if ($this->input->post('course')) {
														    $ar = $this->input->post('course');
														    if (in_array('GRADING', $ar)) {
														        echo "checked";
														    }
														} ?> > GRADING</label>
...
<!-- <input type="text" class="form-control" name="addr" value="<?php echo set_value('addr'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-8" style="float: center">
                                        ...
                                        <input type="submit" name="jewellery_d">
