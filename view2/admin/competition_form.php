                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/competitionupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/competition_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Competition</div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div style="float: left;" class="col-lg-4">Name Of Event </div>
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <textarea class="form-control" name="datet" value="<?php echo set_value('datet'); ?>"><?php echo @$ed[0]->datet; ?></textarea>


                        <!-- <input type="date" class="form-control" name="datet" value="<?php echo set_value('datet'); ?>"> -->
                        ...
                        <!-- <input type="text" class="form-control" name="phone" maxlength="10" value="<?php echo set_value('phone'); ?>"> -->
                                ...
                                <div align="" class="row form-group">
                                    ...
                                    <div class="col-lg-8" style="float: center">
                                        ...
                                        <input type="submit" name="competition">
