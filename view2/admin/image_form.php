...
<html>
    ...
    <head>
        ...
        <title>Image Consultant Form</title>
                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/imageupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form class="form-horizontal" method="post" action="<?php base_url("admin/image_form") ?>" enctype="multipart/form-data">

                                <div align="center" class="row">

                                    <div class="col-lg-4">Selected Category</div>

                                    <div class="col-lg-4">Education & Training / Image Consultant</div>
