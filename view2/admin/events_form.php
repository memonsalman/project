                ...
                <div class="graph-2 general">
                    ...
                    <div class="row">
                        ...
                        <div style="float: right;">
                            <a href="<?php echo site_url("admin/eventupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                        </div>
                    </div>
                    ...
                    <div class="grid-1">
                        ...
                        <div class="form-body">
                            ...
                            <form method="post" class="form-horizontal" action="<?php base_url("admin/events_form") ?>" enctype="multipart/form-data" >
                                ...
                                <div align="center" class="row">
                                    ...
                                    <div class="col-lg-4">Education & Training / Events</div>
                                ...
                                <!-- <div align="" class="row form-group">
                                 ...
                                 <div style="float: left;" class="col-lg-4">Artist</div>
             
                                 <div class="col-lg-4">
             
                                     <input type="text" class="form-control" name="artist" value="<?php echo set_value('artist'); ?>">
