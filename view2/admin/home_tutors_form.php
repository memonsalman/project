                        ...
                        <div class="graph-2 general">
                            ...
                            <div class="row">
                                ...
                                <div style="float: right;">
                                    <a href="<?php echo site_url("admin/hometutorupdate"); ?>"><button type="button" class="btn btn-info">List</button></a>
                                </div>
                            </div>
                            ...
                            <div class="grid-1">
                                ...
                                <div class="form-body">
                                    ...
                                    <form method="post" class="form-horizontal" action="<?php base_url("admin/home_tutors_form") ?>" enctype="multipart/form-data" >
                                        ...
                                        <div align="center" class="row">
                                            ...
                                            <div class="col-lg-4">Education & Training / Home Tutuors</div>
                                                ...
                                                <div class="multiselect">
                                                    ...
                                                    <div id="checkboxes">
                                                        ...
                                                        <label for="four">
                                                            ...
                                                            <input type="checkbox"   value="ISC" <?php if (in_array("ISC", $hh)) {
                                                                echo "checked='checked'";
                                                            } ?> name="board[]" <?php if ($this->input->post('board')) {
                                                                $ar = $this->input->post('board');
                                                                if (in_array('ISC', $ar)) {
                                        ...
                                        <div align="" class="row form-group">
                                            ...
                                            <div class="col-lg-4">For Class</div>

                                            <div class="col-lg-4">

                                                <input type="text" class="form-control" name="class" value="<?php echo set_value('class'); ?><?php echo @$ed[0]->class; ?>">
